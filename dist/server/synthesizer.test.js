...
describe("synthesize", () => {
    test("prompt body includes judgeOutput JSON", async () => {
        ...
        await synthesize(client, "session-1", sampleJudgeOutput, samplePanelResults, sampleConfig, originalModel);
    ...
    test("returns the content string from the client response", async () => {
        ...
        // WHEN synthesize is called
        const result = await synthesize(client, "session-1", sampleJudgeOutput, samplePanelResults, sampleConfig, originalModel);
