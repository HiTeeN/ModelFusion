...
function mockHappyClient(models) {
    const state = { calls: [], maxConcurrent: 0 };
    let concurrent = 0;
    const client = {
        session: {
            prompt: async (params) => {
...
function mockPartialFailClient(models) {
    const state = { calls: [], maxConcurrent: 0 };
    let concurrent = 0;
    const client = {
        session: {
