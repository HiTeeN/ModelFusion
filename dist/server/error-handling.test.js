...
import { runJudge, sanitizeConfigValue } from "./judge.js";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
function makeConfig(models) {
    return {
...
describe("judge panel result sanitization", () => {
    test("judge prompt sanitization: strips control chars from panel content", async () => {
        ...
        const parts = capturedBodies[0]?.parts;
