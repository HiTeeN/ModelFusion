...
describe("createFusionTool", () => {
    ...
    test("returns a tool definition with description, args, and execute", () => {
        const mockPipeline = async () => ({ status: "ok", responses: [], cost: { totalPromptTokens: 0, totalCompletionTokens: 0, estimatedCost: 0 } });
    ...
    test("execute calls pipelineFn with the correct prompt", async () => {
        ...
        const mockPipeline = async (_client, _sessionID, prompt) => {
            capturedPrompts.push(prompt);
            return { status: "ok", responses: [], cost: { totalPromptTokens: 0, totalCompletionTokens: 0, estimatedCost: 0 } };
        };
        const fusionTool = createFusionTool({
            pipelineFn: mockPipeline,
            client: mockClient,
        ...
        const result = await fusionTool.execute({ prompt: "What is the meaning of life?" }, {
...
//# sourceMappingURL=tool-registration.test.js.map