...
export const JUDGE_OUTPUT_SCHEMA = {
    ...
    properties: {
        consensus: {
            type: "array",
            description: "Points where multiple models agree on the same conclusion",
            items: {
                type: "object",
                additionalProperties: false,
        ...
        partial_coverage: {
            type: "array",
            description: "Topics or subtopics that only some models addressed",
            items: {
                type: "object",
                additionalProperties: false,
        ...
        unique_insights: {
            type: "array",
            description: "Valuable contributions made by only a single model",
            items: {
                type: "object",
                additionalProperties: false,
        ...
        blind_spots: {
            type: "array",
            description: "Important aspects of the query that no model addressed",
            items: { type: "string" },
        },
        scoring: {
            type: "array",
        ...
        winner: {
            type: "string",
            description: "The model ID judged to have provided the best overall response, or null if no clear winner",
        },
    },
};
