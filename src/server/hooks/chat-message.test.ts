...
import { createChatMessageHook, type ChatMessagePluginState } from "./chat-message.js";
...
function makeInput(overrides: Partial<Parameters<ReturnType<typeof createChatMessageHook>>[0]> = {}): Parameters<ReturnType<typeof createChatMessageHook>>[0] {
  return {
...
function makePluginState(overrides: Partial<ChatMessagePluginState> = {}): ChatMessagePluginState {
  return {
    ...
    })) as unknown as ChatMessagePluginState["pipeline"],
    client: {} as ChatMessagePluginState["client"],
    ...overrides,
  };
}
