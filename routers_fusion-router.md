---
title: Fusion Router
subtitle: Multi-model deliberation as a model slug
headline: Fusion Router | Multi-model AI Deliberation with OpenRouter
canonical-url: 'https://openrouter.ai/docs/guides/routing/routers/fusion-router'
'og:site_name': OpenRouter Documentation
'og:title': Fusion Router - openrouter/fusion
'og:description': >-
  Use the openrouter/fusion model slug to access multi-model deliberation — a
  panel of models, a judge, and a final answer — in a single API call.
'og:image':
  type: url
  value: >-
    https://openrouter.ai/dynamic-og?title=Fusion%20Router&description=Multi-model%20deliberation%20as%20a%20model%20slug
'og:image:width': 1200
'og:image:height': 630
